                ...
                <ul class="navbar-nav mb-0 ms-auto">
                  ...
                  <li class="nav-item dropdown">
                    ...
                    >
                      ...
                      <li>
                        <a class="dropdown-item border-0" href="ticket.html"
                          ><i class="fa fa-chevron-right font_12 me-1"></i>
                          Ticket</a
                        >
                      </li>
                    ...
                    <div class="trend_2i position-relative">
                        ...
                        <div class="trend_2i2 bg_back position-absolute w-100 h-100 top-0 px-4">
                            <h6 class="font_14 text-light">
                                <?php echo $row['genre']; ?> / <?php echo $row['duration']; ?> Mins
                            </h6>
                            <h5>
                            ...
                            <h6 class="mb-0 mt-3">
                                <a class="button_1 p-2 px-3 font_14" href="../frontend/ticket.html">Get Ticket</a>
                            </h6>
                        </div>
                    </div>
                </div>
