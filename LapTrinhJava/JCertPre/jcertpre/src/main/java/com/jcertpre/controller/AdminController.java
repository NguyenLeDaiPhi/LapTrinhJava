...
public class AdminController {
    ...
    public String viewLearners(Model model) {
        List<Learner> filteredLearners = learnerService.getAllLearners().stream()
            .filter(l -> "USER".equalsIgnoreCase(l.getRole()))
            .toList();
                 model.addAttribute("learners", filteredLearners);
        return "learners";
    }
