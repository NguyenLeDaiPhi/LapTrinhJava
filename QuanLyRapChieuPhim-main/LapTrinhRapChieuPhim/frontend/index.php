            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mb-0 ms-auto">
                  ...
                  <!-- <li class="nav-item dropdown">
                    ...
                    >
                      ...
                      <li>
                        <a class="dropdown-item border-0" href="details.php"
                ...
                <ul class="navbar-nav mb-0 ms-auto">
                  ...
                  <li class="nav-item">
                    <a class="nav-link fs-5 drop_icon" href="login.php"
                ...
                <div class="carousel-caption d-md-block">
                  ...
                  <ul class="mb-0 mt-4">
                    ...
                    <li class="d-inline-block ms-2">
                      <a class="button_1" href="ticket.php"
        ...
        <div class="row feat_2">
          <div class="col-md-4">
            <div class="feat_2i position-relative">
              ...
              <div class="feat_2i2 position-absolute bg-white shadow_box p-4">
                <h5><a href="details.php">Spider-Man: No Way Home </a></h5>
          ...
          <div class="col-md-4">
            <div class="feat_2i position-relative">
              ...
              <div class="feat_2i2 position-absolute bg-white shadow_box p-4">
                <h5><a href="details.php">Chú Chuột Đầu Bếp </a></h5>
                <h6 class="font_14 mt-3">
          ...
          <div class="col-md-4">
            <div class="feat_2i position-relative">
              ...
              <div class="feat_2i2 position-absolute bg-white shadow_box p-4">
                <h5><a href="details.php">Venom Season 3 </a></h5>
                <h6 class="font_14 mt-3">
