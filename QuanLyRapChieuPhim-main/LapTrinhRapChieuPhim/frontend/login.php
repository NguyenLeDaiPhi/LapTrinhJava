	   ...
	   <ul class="navbar-nav mb-0 ms-auto">
		...
		<li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu drop_1" aria-labelledby="navbarDropdown">
			...
			<li><a class="dropdown-item border-0" href="ticket.php"><i class="fa fa-chevron-right font_12 me-1"></i> Vé </a></li>
          </ul>
        </li>
 ...
 <div class="container-xl">
  <div class="row centre_o1 text-center">
    <div class="col-md-12">
	  ...
	  <h5 class="mb-0 mt-3 fw-normal col_oran"><a class="text-light" href="index.php">Trang chủ</a> <span class="mx-2 text-muted">/</span> Đăng nhập </h5>
   </div>
  </div>
 </div>
</section>
